<?php
include("./Frontend/Asset/includes/init.php");
include(pathOf('Frontend/Asset/Components/Header.php'));
?>
<!-- ============== Main content =================-->
<section id="home" class="flex flex-wrap text-center justify-center md:text-left px-5 py-5 lg:py-20">
  <div class="grid md:grid-cols-2 sm:grid-cols-12 mt-16">
    <div class="w-4/5 h-4/5 mx-8 md:my-10">
      <img src="<?= urlOf('Frontend/Asset/Images/img.webp') ?>" alt="" class="">
    </div>
    <div>
  ...
  <div class="sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div class="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
        <div class="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
          <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg hover:cursor-pointer">
            <div class="justify-center lg:block flex">
              <img src="<?= urlOf('Frontend/Asset/Images/access.png') ?>" alt="" class="h-20">
            </div>
            <div class="mt-5">
        ...
        <div class="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
          <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg hover:cursor-pointer">
            <div class="justify-center lg:block flex">
              <img src="<?= urlOf('Frontend/Asset/Images/share.png') ?>" alt="" class="h-20">
            </div>
            <div class="mt-5">
        ...
        <div class="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
          <div class="max-w-sm p-6 border border-gray-200 hover:shadow-lg hover:cursor-pointer">
            <div class="justify-center lg:block flex">
              <img src="<?= urlOf('Frontend/Asset/Images/security.png') ?>" alt="" class="h-20">
            </div>
            <div class="mt-5">
...
<!-- ============== Teams =================-->
<?php
include("./Frontend/Asset/Components/team.php");
?>
...
<?php
include("./Frontend/Asset/Components/Footer.php");
?>
</body>
</html>
<!-- 
