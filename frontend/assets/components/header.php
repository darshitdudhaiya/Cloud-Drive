    ...
    <nav class="shadow-md fixed w-screen bg-[#F3FCFC] z-30">
      <div class="relative max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div class="flex md:order-2 gap-2">
          ...
          <button type="button" id="toggleBtn" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden group bg-gradient-to-br from-purple-600 to-blue-500 group-hover:from-purple-600 group-hover:to-blue-500 hover:text-white dark:text-white focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800">
          ...
          <div class="space-y-6">
            ...
            <div>
              <ul class="flex flex-col text-md mt-4">
                ...
                ?>
                <li class="navItem">
                  <a href='../../../index' class=" block py-2 pl-3 pr-4 text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 hover:text-indigo-600">Contact</a>
                </li>
              </ul>
            </div>
          </div>
