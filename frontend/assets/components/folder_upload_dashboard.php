...
<div class="w-screen bg-gray-100 h-screen flex items-center justify-center">
  <div class="relative inline-block tooltip">
            ...
            <div class="m-4">
                ...
                <div class="flex items-center justify-center w-full">
                    <label class="flex flex-col w-full h-32 border-4 border-dashed hover:bg-gray-100 hover:border-gray-300">
                        ...
                        <input type="file" class="opacity-0" id="file"  name="files[]"  multiple directory="" webkitdirectory="" moxdirectory="" />
                    </label>
                </div>
            </div>
            ...
            <article aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                ...
                <section class="h-full overflow-auto p-8 w-full h-full flex flex-col">
                    <header class="border-dashed border-2 border-gray-400 py-12 flex flex-col justify-center items-center">
                        ...
                        <input id="hidden-input" type="file"  class="hidden"  name="files[]"  multiple directory="" webkitdirectory="" moxdirectory=""/>
    ...
    <form action="../includes/upload_folder.php" method="post" enctype="multipart/form-data">
        <div class="w-full px-4 sm:w-1/2 lg:w-1/4">
            <div class="mb-14">
                <div class="group relative inline-block">
                    <button class="bg-primary inline-flex rounded py-2 px-[18px] text-base font-semibold text-white">
                        Tooltip on right
                    </button>
        ...
        </div><input type="text" name="foldername" />
