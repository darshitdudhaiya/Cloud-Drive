    ...
    <div class="mt-20">
        <form class="my-20 w-96 border border-gray-100 p-7 pb-1 shadow-xl" id="form">
            ...
            <div class="text-center">
                ...
                <a href="<?=urlOf('frontend/assets/pages/forgot_password_form')?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Reset password</a>
            </div>
        </form>
    </div>
</div>
...
<script>
    ...
    $("#form").on("submit", function(e) {
        ...
        if (
            ...
            $.ajax({
                url: "/drive/backend/api/Auth/login/",
                type: "POST",
...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden mt-8 lg:mt-20" style="max-width:1000px">
