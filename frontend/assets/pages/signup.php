...
<div class="relative z-10" id="loading-image" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <div class="absolute my-80 lg:my-80 inset-0 flex max-h-full items-center justify-center p-4 text-center sm:items-center sm:p-0">
    ...
    <div class="mt-20">
        <form class="my-10 w-96 border border-gray-100 p-7 shadow-xl" id="form">
            ...
            <div class="text-center">
                <a href="<?=urlOf('frontend/assets/pages/login')?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">I have an account.</a><br>
            </div>
        </form>
...
<script>
    ...
    let file = new File([''], "../images/download.jpg");
console.log(file)
    let form_data_signup = new FormData();
    ...
    $("#form").on("submit", function(e) {
        ...
        if (
            ...
            $("#name").addClass('dark:border-rose-500');
            ...
            form_data_signup.append("file", file);
            form_data_signup.append("name", $("#name").val());
            form_data_signup.append("email", $("#email").val());
            form_data_signup.append("password", $("#password").val());

            $.ajax({
                url: "/drive/backend/api/Auth/signup/",
                type: "POST",
                processData: false,
                contentType: false,
                ...
                success: function(data, textStatus, jqXHR) {
                    ...
                    if (jqXHR.status == 200) {
                        open("../components/dashboard", "_self");
                    } else {
...
<div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
    <div class="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden mt-20" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-indigo-500 py-16 px-10">
            ...
            <form class="w-full md:w-1/2 py-10 px-5 md:px-10" id="form">
                <div class="text-center mb-10">
                    <h1 class="font-bold text-3xl text-gray-900">SIGN UP</h1>
                </div>
                <div class="relative z-0 w-full text-center hidden" id="error">
                    <span id="error_display" class="text-md font-bold text-rose-500 xl:inline sm:inline md:inline lg:inline">
                    </span>
                </div>
                <div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="text" id="name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="email" id="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            ...
                            <div class="flex">
                                ...
                                <input type="password" id="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-12">
                            ...
                            <div class="flex">
                                <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                <input type="password" id="conform_password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="************">
                            </div>
                        </div>
                    </div>
                    <div class="flex -mx-3">
                        <div class="w-full px-3 mb-5">
                            <button type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Create account</button>
                        </div>
                    </div>
                    <!-- <div class="text-center">
                        <a href="<?=urlOf('frontend/assets/pages/login')?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">I have an account.</a><br>
